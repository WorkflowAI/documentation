Once you have a agent working on a first, you need to test it with more inputs. Since LLMs are not deterministic, the fact that it works on a first input doesn't mean it will work on the next one. 
